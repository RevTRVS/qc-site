      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <h1 className="text-6xl font-black mb-4">
            <span className="gradient-text">Link Converter</span>
          </h1>
          <p className="text-gray-400 text-lg">
            Convert product links from Taobao, Tmall, Weidian, or 1688 to Rizzitgo format
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-effect rounded-xl p-6 border border-purple-500/20">
            ...
            <textarea
              ...
              className="w-full h-40 bg-white/5 border border-white/10 rounded-xl p-4 text-white placeholder-gray-500 focus:outline-none focus:border-purple-400/50 focus:ring-1 focus:ring-purple-400/30 resize-none transition-all duration-300"
            />
            ...
            <button
              ...
              className={`mt-6 w-full py-3 rounded-xl font-bold text-lg transition-all duration-300 border-2 ${
                inputLinks.trim()
                  ? "bg-gradient-to-r from-purple-600 to-pink-600 border-purple-500 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/50"
                        ...
                        {result.status === "success" ? (
                          <>
                            ...
                            <div className="flex items-center gap-2">
                              <p className="text-sm text-purple-400 break-all flex-1">
                                {result.rizzitgo}
                              </p>
                              <button
                                onClick={() =>
                                ...
                                className="flex-shrink-0 p-2 bg-purple-500/20 hover:bg-purple-500/40 text-purple-400 rounded transition-all duration-300"
