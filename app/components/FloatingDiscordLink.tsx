export default function FloatingDiscordLink() {
  return (
    <a
      ...
      className="fixed right-6 top-1/2 -translate-y-1/2 z-30 flex flex-col items-center gap-2 p-4 rounded-xl bg-gradient-to-b from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50 active:scale-95 group"
      title="Join Discord Server"
    >
      <svg className="w-8 h-8 transition-transform group-hover:rotate-12" viewBox="0 0 24 24" fill="currentColor">
      ...
      <span className="text-xs whitespace-nowrap">Discord</span>
    </a>
  );
}
