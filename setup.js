...
const dirs = [
  'app/tools/link-converter',
  'app/tools/shipping-calculator'
];
...
fs.writeFileSync('app/tools/page.tsx', toolsPage);
console.log('Created: app/tools/page.tsx');
